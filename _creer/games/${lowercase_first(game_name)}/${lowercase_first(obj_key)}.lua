...
%>    --- (inherited) ${attr_parms['description']}
...
%>--- ${'(inherited) ' if do_inherited else ''}${function_parms['description']}
% if do_inherited:
...
-- @tparam${"" if not arg_parms['optional'] else ("[opt=" + shared['lua']['value'](arg_parms['type'], arg_parms['default']) + "]")} ${shared['lua']['type'](arg_parms['type'])} ${arg_parms['name']} ${arg_parms['description']}
% endfor
% endif
