-- Generated by Creer at 01:14AM on August 12, 2015 UTC, git hash: '44abe78df9634b90415f2d1791a923bdc6e4f5c6'
...
function Checker:isMine()
    return not not (self:_runOnServer(self, "isMine", {
    }))
end
...
function Checker:move(x, y)
    return (self:_runOnServer(self, "move", {
        x = x,
        y = y,
    }))
end
