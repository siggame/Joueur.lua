...
--- the AI functions for the JungleChess game.
-- @classmod AI
...
function AI:getName()
    ...
    return "JungleChess Lua Player" -- REPLACE THIS WITH YOUR TEAM NAME!
...
-- @treturn string A string formatting for the move you want to make. If the move is invalid or not properly formatted you will lose the game.
